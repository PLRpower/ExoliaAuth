package fr.exolia.auth.mineweb;
...
import fr.exolia.auth.mineweb.utils.*;
    ...
    public static void start() throws DataWrongException, DataEmptyException, ServerNotFoundException, IOException {
        ...
        if (strTpConnect.equalsIgnoreCase("0")) {
            ...
            if (strTpConnect.equalsIgnoreCase(String.valueOf(TypeConnection.launcher))) {
                Core.log("Démarrage de l'authentification vers " + fr.exolia.auth.mineweb.utils.Get.getCore.getURLRoot());
                ...
                try {
                    ...
                    Core.log("===============================================");
                    Core.log("Données enregistrées:");
                    Core.log("Pseudo: " + fr.exolia.auth.mineweb.utils.Get.getSession.getUsername());
                    Core.log("UUID: " + fr.exolia.auth.mineweb.utils.Get.getSession.getUuid());
                    Core.log("AccessToken: " + fr.exolia.auth.mineweb.utils.Get.getSession.getAccessToken());
                    Core.log("ClientToken: " + fr.exolia.auth.mineweb.utils.Get.getSession.getClientToken());
                    Core.log("===============================================");
